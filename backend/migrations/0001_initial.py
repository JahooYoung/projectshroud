...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='admins',
            field=models.ManyToManyField(related_name='admins', through='backend.UserManageEvent', to='backend.UserProfile'),
        ),
        migrations.AddField(
            model_name='event',
            name='host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='backend.UserProfile', verbose_name='创建者'),
        ),
        migrations.AddField(
            model_name='event',
            name='registered_attendee',
            field=models.ManyToManyField(related_name='registered_attendee', through='backend.UserRegisterEvent', to='backend.UserProfile'),
        ),
    ]
